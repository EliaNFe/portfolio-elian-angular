...
@Component({
  ...
  template: `
    <div [class.dark]="isDarkMode">
      <div class="min-h-screen transition-colors duration-700 bg-slate-100 dark:bg-slate-950 text-slate-900 dark:text-white font-sans selection:bg-fuchsia-500/30 scroll-smooth relative overflow-x-hidden">

        <div class="fixed inset-0 -z-20 overflow-hidden pointer-events-none">
          <div class="absolute top-[-10%] left-[-10%] w-[80%] h-[80%] bg-amber-200/30 dark:bg-fuchsia-600/10 blur-[130px] rounded-full transition-colors duration-700"></div>
          <div class="absolute bottom-[-10%] right-[-10%] w-[60%] h-[60%] bg-rose-200/30 dark:bg-rose-600/10 blur-[120px] rounded-full transition-colors duration-700"></div>
          <div class="absolute top-[30%] right-[15%] w-[40%] h-[40%] bg-violet-200/20 dark:bg-violet-600/5 blur-[100px] rounded-full transition-colors duration-700"></div>

          <div class="absolute inset-0 opacity-[0.04] dark:opacity-[0.15]" 
               style="background-image: radial-gradient(circle at 1px 1px, currentColor 1px, transparent 0); background-size: 40px 40px; mask-image: radial-gradient(circle at center, black, transparent 80%);">
          </div>
        </div>

        <nav class="fixed top-0 w-full z-50 bg-white/70 dark:bg-slate-950/70 backdrop-blur-xl border-b border-slate-300 dark:border-slate-800 px-6 py-4">
          <div class="max-w-6xl mx-auto flex justify-between items-center">
            ...
            <div class="flex items-center gap-6">
              ...
              <button (click)="toggleDarkMode()" class="p-2.5 rounded-xl bg-slate-200 dark:bg-slate-800 hover:bg-slate-300 dark:hover:bg-slate-700 transition-all text-lg shadow-inner">
                {{ isDarkMode ? '☀️' : '🌙' }}
              </button>
        ...
        <header class="pt-56 pb-32 px-6 text-center max-w-5xl mx-auto relative">
          <div class="mb-10 relative inline-block group cursor-pointer">
            ...
            <div class="relative w-32 h-32 md:w-44 md:h-44 rounded-full p-1 bg-gradient-to-tr from-fuchsia-500 via-violet-500 to-rose-500 shadow-2xl transition-all duration-500 ease-out group-hover:scale-105 group-hover:rotate-2">
              <div class="w-full h-full rounded-full overflow-hidden border-4 border-slate-100 dark:border-slate-950 bg-slate-200 transition-all duration-500 group-hover:border-white/20">
          ...
          <h1 class="block text-5xl md:text-6xl lg:text-7xl font-black mb-8 tracking-tighter leading-[1.1] relative group cursor-default">
            <span class="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-500 dark:from-white dark:via-white dark:to-slate-400 bg-clip-text text-transparent transition-opacity drop-shadow-sm">
            Elian Ferreyra
            </span>
          ...
          <p class="text-slate-700 dark:text-slate-400 text-lg md:text-xl font-light leading-relaxed max-w-2xl mx-auto">
            ...
            Especializado en <span class="text-rose-600 dark:text-rose-500 font-semibold">Java</span> para el core e interfaces fluidas con <span class="text-violet-600 dark:text-violet-500 font-semibold">Angular</span>.
          </p>
        </header>

        <section id="sobre-mi" class="max-w-5xl mx-auto px-6 mb-20 scroll-mt-32">
          <div class="group relative p-10 md:p-14 rounded-[2.5rem] bg-white dark:bg-slate-900/80 border border-slate-300 dark:border-slate-700/50 shadow-xl shadow-slate-200/50 dark:shadow-2xl dark:shadow-black/50 backdrop-blur-md transition-all duration-700 hover:-translate-y-2 hover:border-fuchsia-500/30 overflow-hidden">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-12 items-start relative z-10">
              ...
              <div class="md:col-span-2 space-y-6 text-slate-700 dark:text-slate-400 text-base font-light leading-relaxed">
                <p>
                  Soy desarrollador con foco en la <span class="text-slate-900 dark:text-white font-medium border-b border-slate-300 dark:border-slate-600">mantenibilidad y la claridad del código</span>. 
                  Me gusta construir soluciones que no solo funcionen hoy, sino que sean fáciles de entender y escalar mañana.
                </p>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4 border-t border-slate-200 dark:border-slate-800 leading-snug">
        ...
        <section class="max-w-5xl mx-auto px-6 mb-40">
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="group relative p-8 rounded-[2rem] bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700/50 hover:border-violet-500/50 dark:hover:border-violet-500/50 transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl shadow-sm dark:shadow-none overflow-hidden cursor-default">
            ...
            <div class="group relative p-8 rounded-[2rem] bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700/50 hover:border-fuchsia-500/50 dark:hover:border-fuchsia-500/50 transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl shadow-sm dark:shadow-none overflow-hidden cursor-default">
        ...
        <main id="proyectos" class="max-w-6xl mx-auto px-6 pb-40 scroll-mt-32 relative z-10">
          <div class="flex flex-col md:flex-row justify-between items-end mb-20 gap-6">
            <div>
              <h2 class="text-xs font-black text-fuchsia-600 dark:text-fuchsia-500 uppercase tracking-[0.4em] mb-4">Portfolio</h2>
            ...
            <div *ngFor="let p of proyectos" 
              ...
              <div class="h-80 overflow-hidden relative border-b border-slate-200 dark:border-slate-800 group/img cursor-zoom-in"
                ...
                <img [src]="p.imagenSeleccionada || p.imagen" [alt]="p.titulo" 
                     class="w-full h-full object-cover grayscale opacity-80 group-hover:grayscale-0 group-hover:opacity-100 group-hover:scale-110 transition-all duration-1000 ease-in-out">
                
                <div class="absolute inset-0 bg-gradient-to-t from-white dark:from-slate-900 via-transparent to-transparent opacity-90"></div>
                ...
                <div class="absolute top-4 right-4 flex flex-col gap-2 translate-x-12 opacity-0 group-hover/img:translate-x-0 group-hover/img:opacity-100 transition-all duration-500 z-20">
                  <div *ngFor="let imgPath of p.galeria?.slice(0, 4)" 
                       ...
                       class="w-14 h-14 rounded-xl border-2 border-white dark:border-slate-800 shadow-lg overflow-hidden cursor-pointer hover:scale-110 hover:border-fuchsia-500 transition-all bg-black">
              ...
              <div class="p-10 relative z-10">
                ...
                <h3 class="text-3xl font-bold mb-4 tracking-tighter dark:text-white group-hover:text-fuchsia-600 dark:group-hover:text-fuchsia-400 transition-colors duration-500">
                  {{ p.titulo }}
                </h3>
                ...
                <div class="flex items-center gap-6 text-[11px] uppercase tracking-widest font-black">
                  <a [href]="p.github" target="_blank" class="text-slate-700 dark:text-white hover:text-rose-600 dark:hover:text-rose-500 transition-colors duration-300">GitHub Repo</a>
                  <a *ngIf="p.demo" [href]="p.demo" target="_blank" 
                     class="px-8 py-3 bg-gradient-to-br from-fuchsia-600 via-violet-600 to-rose-600 text-white rounded-xl hover:shadow-lg hover:shadow-fuchsia-500/30 hover:scale-105 active:scale-95 transition-all duration-500 leading-none">
                    Launch
                  </a>
                </div>
              </div>
          ...
          <ng-template #loading>
            <div class="text-center py-32 animate-pulse">
                ...
                <p class="text-slate-500 dark:text-slate-400 uppercase text-[10px] tracking-[0.5em] font-bold">Iniciando Sistemas...</p>
            </div>
          </ng-template>
        </main>

        <section id="contacto" class="max-w-4xl mx-auto px-6 mb-40 scroll-mt-32">
          <div class="py-16 px-8 rounded-[3rem] bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700/50 shadow-xl shadow-slate-200/50 dark:shadow-2xl text-center relative overflow-hidden group hover:-translate-y-2 transition-all duration-700 hover:border-fuchsia-500/30 isolate z-10">
            <div class="absolute -bottom-24 -left-24 w-64 h-64 bg-fuchsia-600/10 blur-[100px] rounded-full group-hover:bg-fuchsia-600/20 group-hover:scale-150 transition-all duration-1000 -z-10"></div>
            ...
            <div class="flex flex-wrap justify-center gap-6 relative z-10 text-[11px] uppercase tracking-widest font-black">
              ...
              <a href="https://linkedin.com/in/elian-ferreyra" target="_blank" class="px-10 py-4 bg-white dark:bg-slate-800 text-slate-900 dark:text-white rounded-2xl border border-slate-300 dark:border-slate-600 hover:bg-slate-50 dark:hover:bg-slate-700 transition-all hover:scale-105 shadow-sm">LinkedIn</a>
              <a href="https://wa.me/5492262580172" target="_blank" class="px-8 py-4 bg-gradient-to-br from-emerald-600 to-teal-700 text-white rounded-2xl hover:scale-110 active:scale-95 transition-all duration-500 shadow-lg shadow-emerald-600/20">WhatsApp</a>
            </div>
          </div>
        </section>

        <footer class="pb-16 text-center relative z-10">
          <div class="inline-block px-8 py-3 bg-white/80 dark:bg-slate-900/80 border border-slate-300 dark:border-slate-800 rounded-full backdrop-blur-md text-slate-700 dark:text-slate-400 text-[9px] uppercase font-black tracking-[1.1em] shadow-sm">
            Elian Ferreyra <span class="mx-4 text-slate-300 dark:text-slate-700">|</span> 2026 <span class="mx-4 text-slate-300 dark:text-slate-700">|</span> Argentina
          </div>
        </footer>

        <div *ngIf="proyectoActivo" 
             class="fixed inset-0 z-[100] flex items-center justify-center bg-slate-900/95 backdrop-blur-xl p-4 md:p-10 animate-in fade-in duration-300"
             (click)="closeModal()">
          ...
          <button (click)="prevFoto($event)" class="absolute left-4 z-[110] p-4 bg-white/10 hover:bg-white/20 border border-white/10 rounded-full text-white backdrop-blur-md transition-all">
          ...
          <div class="relative max-w-6xl w-full h-full flex flex-col items-center justify-center gap-6" (click)="$event.stopPropagation()">
            ...
            <div class="text-center bg-slate-900/50 px-6 py-3 rounded-2xl backdrop-blur-sm border border-white/5">
          ...
          <button (click)="nextFoto($event)" class="absolute right-4 z-[110] p-4 bg-white/10 hover:bg-white/20 border border-white/10 rounded-full text-white backdrop-blur-md transition-all">
